...
if (isset($_POST["submit"])) {
	...
	$query = "INSERT INTO pengeluaran VALUES ('','$keterangan', '$nominal','$tanggal', '$bulan')";
		...
		<section id="input">
			...
			<main>
				...
				<form action="" method="post">
					...
					<button type="submit" name="submit" style="background: coral">Simpan</button>
				</form>
